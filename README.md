<div align="center">
  ...
  <img
    width="100%"
    src="https://capsule-render.vercel.app/api?type=waving&color=0:7F5AF0,100:2CB67D&height=190&section=header&text=Hi,%20I'm%20Mejji&fontSize=46&fontColor=ffffff&animation=fadeIn&fontAlignY=35"
    alt="Header"
  />

  <h3>AI Software Engineer • Agentic AI • RAG • ML Systems</h3>

  <p>
    Building practical AI systems, intelligent applications, and scalable software.
  </p>

  <p>
    <img
      src="https://komarev.com/ghpvc/?username=Mejji&label=Profile%20Views&color=7F5AF0&style=flat"
      alt="Profile Views"
    />
    <img
      src="https://img.shields.io/github/followers/Mejji?label=Followers&style=flat&color=2CB67D"
...
`Python` `PyTorch` `Deep Learning` `Graph Neural Networks` `OpenCV`
...
- Integrated a custom food classifier with thousands of food categories
- Implemented local nutrition search using Room and full-text search
- Integrated Android Health Connect
- Designed hardware-aware AI model routing
- Built coroutine-safe streaming LLM inference
...
`React` `Next.js` `TypeScript` `Supabase` `PostgreSQL` `Gemini`

Built and delivered an AI-driven employee development platform during a hackathon.

- Built an AI coaching assistant using Gemini
- Implemented Retrieval-Augmented Generation
- Designed role-based access control and row-level security
- Built employee analytics and adaptive learning interfaces
- Developed the full-stack system from prototype to deployed application
...
Built a semantic movie search engine using vector embeddings.

- Converted thousands of movie descriptions into vector embeddings
- Implemented semantic similarity search using Qdrant
- Built a complete **Retrieve → Augment → Generate** pipeline
- Integrated Llama-based generation using retrieved movie context
- Created PCA-based visualizations for embedding analysis
...
- Tested specialized Data Science and Vision models
- Investigated reasoning failures and edge cases
- Improved prompting and model evaluation workflows
- Worked on AI safety, reliability, and hallucination reduction
...
- Developed an NFC-based employee timekeeping system
- Automated operational workflows previously handled through spreadsheets
- Designed and deployed network infrastructure
